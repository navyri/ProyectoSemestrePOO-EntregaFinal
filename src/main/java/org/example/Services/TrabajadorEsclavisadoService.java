...
public class TrabajadorEsclavisadoService {
    ...
    public TrabajadorEsclavisado findById(UUID id) {
        return trabajadorEsclavisadoRepository.findById(id).orElseThrow(() ->new RuntimeException("No se encontro trabajador con el id"+id));
    }
    ...
    public void delete(UUID id) {
        findById(id);trabajadorEsclavisadoRepository.deleteById(id);
    }
