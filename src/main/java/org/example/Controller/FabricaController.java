...
public class FabricaController {
    ...
    @PutMapping("/{id}")
    public Fabrica update(@PathVariable UUID id, @RequestBody Fabrica f) { f.setId(id); return objFabrica.save(f); }

    @DeleteMapping("/{id}")
    public void delete(@PathVariable UUID id) { objFabrica.delete(id); }
